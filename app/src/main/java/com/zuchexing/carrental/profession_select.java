...
public class profession_select extends AppCompatActivity {
    TitleLayout title;
    String[] letter={
            "A","B","C",
            "D","F",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profession_select);
        title=(TitleLayout)findViewById(R.id.title);
        data=new ArrayList<>();
        car_tab_lv=(ListView)findViewById(R.id.profession_tab_lv);
